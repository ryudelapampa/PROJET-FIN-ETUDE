...
public class ControllerJourFerie {
	...
	@PostMapping
	public JourFerie addJourFerie(@Valid @RequestBody JourFerie jourFerie, BindingResult result)
	...
	@PutMapping("{id}")
	public JourFerie updateJourFerie(@PathVariable("id") Integer pid, @RequestBody JourFerie jourFerie)
			throws JourFerieNotFoundException {
